...
<body>
    ...
    <header id="header" class="d-flex flex-column justify-content-center">
        <nav id="navbar" class="navbar nav-menu">
            <ul>
                ...
                <li><a href="#footer" class="nav-link scrollto"><i class="bx bxs-message-alt-error"></i> <span>Sobre</span></a></li>
            </ul>
        </nav><!-- .nav-menu -->
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content">
                        ...
                        <p class="fst-italic">
                            A <b>Escola Do Vinho</b> é uma unidade industrial experimental, vinvulada ao curso superior de <b>Tecnologia em Viticultura e Enologia</b>, que serve de apoio para as atividades de ensino,
                            pesquisa e extensão.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <ul>
                                    ...
                                    <li><i class="bi bi-chevron-right"></i> <strong>Instituição:</strong> <span>IFSertãoPE, Campus Petrolina Zona Rural.</span></li>
    ...
    <footer id="footer">
        <div class="container">
            ...
            <a href="{{url('/credits')}}" target="_blank">Créditos e Licenças de uso</a> <br>
            @if (Route::has('login'))
            <div class="">
                @auth
                <a href="{{ url('/home/ver_reagentes') }}" class="text-sm text-gray-700 underline">Acesso administrativo</a>
                @else

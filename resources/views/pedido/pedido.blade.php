                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-primary">
                                                <h4 class="card-title ">Tela de Solicitações</h4>
                                                <p class="card-category">Informe o item que deseja solicitar</p>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <form id="CadIns" action="{{ route('registra_pedidos') }}" method="POST" class="row g-3 needs-validation" novalidate>
                                                        @csrf
                                                        <div class="col-md-4">
                                                            <label for="validationCustom01" class="form-label">Nome do Professor</label>
                                                            <input type="text" class="form-control" id="validationCustom01" required name="nome" placeholder="Professor..">
                                                            <div class="valid-feedback">
                                                                Muito Bem
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="validationCustom02" class="form-label">Selecione o item</label>

                                                            <div class="form-check">
                                                                <input class="" type="radio" name="item" value="Insumo" id="flexRadioDefault1">
                                                                <label class="form-check-label" for="flexRadioDefault1">
                                                                    Insumo
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" name="item" value="Reagentes" id="flexRadioDefault2" checked>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="nome_item" class="form-control" id="validationCustom03" placeholder="Escreva o nome do item" required>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="validationCustom04" class="form-label">Data para utilização</label> <br />
                                                            <input type="date" name="previsão" class="form-control" id="validationCustom04" required> <br />
                                                        </div>
                                                        <div class="col-md-4">
